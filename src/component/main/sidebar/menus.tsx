            ...
            <div id="thm-menu" className=" mt-3 sidebar-obj">
                <ul className="list-group thm-0radius p-0">
                    ...
                    <ul id="ul2-1" className="list-group thm-0radius p-0 collapse">
                        ...
                        <li data-toggle="collapse" data-target="#ul3-2" data-href="#" className="list-group-item list-group-item-action">
                        ...
                        <li id="hardware_management" data-toggle="collapse" data-target="#ul3-3" data-href="manage-hardware.html" className="list-group-item list-group-item-action">
                            <span className="fas fa-keyboard fa-size">&nbsp;&nbsp;</span><span>کالا</span>
                        </li>
                        <li data-toggle="collapse" data-target="#ul3-4" data-href="#" className="list-group-item list-group-item-action">
